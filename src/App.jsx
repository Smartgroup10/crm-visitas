...
export default function App() {
  ...
  // handleAddClient/handleUpdateClient aceptan ahora el payload
  // completo del cliente {name, cif, address, city, postal_code}.
  // El alta inline desde TaskModal sigue mandando solo `{name}` —
  // los campos opcionales se rellenan por defecto a "" en el backend.
